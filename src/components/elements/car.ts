export const carImage = (color: string): string => `<?xml version="1.0"
 standalone="no"?>
<!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 20010904//EN"
 "http://www.w3.org/TR/2001/REC-SVG-20010904/DTD/svg10.dtd">
<svg version="1.0" xmlns="http://www.w3.org/2000/svg"
 width="128" height="66" viewBox="0 0 1280.000000 667.000000"
...
export const flagImage = (): string => `<?xml version="1.0" encoding="iso-8859-1"?>
    <!-- Uploaded to: SVG Repo, www.svgrepo.com, Generator: SVG Repo Mixer Tools -->
    <svg fill="red" height="40px" width="40px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
...
export const carModification: string[] = [
  'Volga',
  'S-Max',
  'C-Max',
  'model S',
...
export const generateCarName = (): string => `${carModel[Math.floor(Math.random() * carModel.length)]} ${
  carModification[Math.floor(Math.random() * carModification.length)]
}`;

export const generateCarColor = (): string => `#${parseInt(`${Math.floor(Math.random() * 0xffffff)}`).toString(16)}`;
